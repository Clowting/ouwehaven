...
<head>
    ...
    <title><?php echo SITE_TITLE; ?> - Reserveringen - Geweigerd</title>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="page-header">
                    <h1>Reserveringen <small>Geaccepteerd</small></h1>
                </div>
                <p>Op deze pagina vindt u de reserveringen die zijn geaccepteerd.</p>
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li role="presentation" class="active"><a href="reservations-approved.php">Geaccepteerd</a></li>
