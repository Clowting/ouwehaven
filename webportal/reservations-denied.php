        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="page-header">
                    <h1>Reserveringen <small>Geweigerd</small></h1>
                </div>
                <p>Op deze pagina vindt u de reserveringen die zijn geweigerd.</p>

                <ul class="nav nav-tabs">
                    <li role="presentation"><a href="reservations.php">In afwachting</a></li>
                    <li role="presentation" class="active"><a href="reservations-denied.php">Geweigerd</a></li>
